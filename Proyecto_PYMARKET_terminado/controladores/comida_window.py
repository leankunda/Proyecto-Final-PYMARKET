...
productos_predefinidos = [
    Productos_Comida("Carro", 20000, "Carro deportivo de alta velocidad", "Comida", 1500, 10),
    Productos_Comida("Moto", 5000, "Motocicleta económica y compacta", "Comida", 200, 15),
    Productos_Comida("Bicicleta", 300, "Bicicleta de montaña resistente", "Comida", 15, 20),
    Productos_Comida("Camión", 80000, "Camión para transporte de carga pesada", "Comida", 4000, 5),
    Productos_Comida("Avión", 200000, "Avión ligero para transporte personal", "Comida", 10000, 2),
]
