...
productos_predefinidos = [
    Productos_Tecnologia("Carro", 20000, "Carro deportivo de alta velocidad", "Comida", 1500, 10),
    Productos_Tecnologia("Moto", 5000, "Motocicleta económica y compacta", "Comida", 200, 15),
    Productos_Tecnologia("Bicicleta", 300, "Bicicleta de montaña resistente", "Comida", 15, 20),
    Productos_Tecnologia("Camión", 80000, "Camión para transporte de carga pesada", "Comida", 4000, 5),
    Productos_Tecnologia("Avión", 200000, "Avión ligero para transporte personal", "Comida", 10000, 2),
]
