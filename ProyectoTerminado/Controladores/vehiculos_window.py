...
productos_predefinidos = [
    Productos_Vehiculos("Carro", 20000, "Carro deportivo de alta velocidad", "Vehiculos", 1500, 10),
    Productos_Vehiculos("Moto", 5000, "Motocicleta economica y compacta", "Vehiculos", 200, 15),
    Productos_Vehiculos("Bicicleta", 300, "Bicicleta de montaña resistente", "Vehiculos", 15, 20),
    Productos_Vehiculos("Camion", 80000, "Camion para transporte de carga pesada", "Vehiculos", 4000, 5),
    Productos_Vehiculos("Avion", 200000, "Avion ligero para transporte personal", "Vehiculos", 10000, 2),
]
